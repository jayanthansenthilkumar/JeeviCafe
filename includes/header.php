...
<div class="app-container">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="manage_polls.php">Voting Engine</a></li>
            <li><a href="menu_manager.php">Manage Live Menu</a></li>
    ...
    <div class="main-content">
        <div class="header">
            <h3><?php echo ($role === 'admin') ? 'Manager Viewpoint' : 'Student Interface'; ?></h3>
            <div class="user-info">
                <?php if($role === 'user'): ?>
